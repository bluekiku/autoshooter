...
// >>>DDDD
	_gStarttablerow() ;	_gStarttabledata('align=center') ;
	    ...
	    _gNewline() ;
		_gInputtext('burst',nBurstcount.toString(),30,255,_gStylefontsize('2.0')) ;
	    _gNewline() ;
	    _gString('Shoot count') ;
	    _gNewline() ;
		_gInputtext('count',nCountlimit.toString(),30,255,_gStylefontsize('2.0')) ;
	    _gNewline() ;
	    _gString('Interval time (sec)') ;
	    _gNewline() ;
		_gInputtext('interval',nInterval.toString(),30,255,_gStylefontsize('2.0')) ;
	    _gNewline() ;
